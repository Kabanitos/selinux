...
```
### Итого:
Проблемой нашего стенда была в том, что SELinux блокировал доступ к обновлению фалов для DNS. В фалах была ошибка конеткста безопасности. Файлы находились в другой директории. 
